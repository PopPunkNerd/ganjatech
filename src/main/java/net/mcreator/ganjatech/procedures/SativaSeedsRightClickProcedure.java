...
public class SativaSeedsRightClickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == GanjatechModItems.SATIVA_SEEDS.get() && (world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == Blocks.FARMLAND
				...
				&& ((world.getBlockState(BlockPos.containing(x, y + 3, z))).getBlock() == Blocks.AIR || (world.getBlockState(BlockPos.containing(x, y + 3, z))).getBlock() == Blocks.VOID_AIR
						|| (world.getBlockState(BlockPos.containing(x, y + 3, z))).getBlock() == Blocks.CAVE_AIR)) {
			world.setBlock(BlockPos.containing(x, y + 1, z), Blocks.AIR.defaultBlockState(), 3);
			world.setBlock(BlockPos.containing(x, y + 1, z), GanjatechModBlocks.SATIVACROP.get().defaultBlockState(), 3);
