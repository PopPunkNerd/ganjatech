...
package net.mcreator.ganjatech.fluid.types;
...
public class RawOilRFluidType extends FluidType {
	public RawOilRFluidType() {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("minecraft:block/honeycomb_block");
